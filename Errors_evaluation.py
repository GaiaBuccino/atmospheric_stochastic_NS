...
if __name__ == "__main__":
    ...
    for test in types_test:
        ...
        which_error = ["weigthedPOD-inv_transform"]#"convAE-FOM", "POD-inv_transform"]#,  "POD-inv_transform", , "POD_NN-inv_transform", "NN_encoder-FOM", "weighted_convAE"]
        ...
        for dim in neurons_linear:
            ...
            for type_err in which_error:
                ...
                if type_err == "weigthedPOD-inv_transform":
                    ...
                    # wPOD model
                    wpod = pod.POD('correlation_matrix', rank = dim, weights=weights)     
                    print("weights = ", weights)
                    wpod.fit(db_training.snapshots.T)
